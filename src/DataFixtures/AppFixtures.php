        ...
        $data = [
            'Séjour' => [
                ...
                'meubles' => [
                    [
                        'Canapé 3 places',
                        'Canapé confortable en tissu gris anthracite, idéal pour 3 personnes.',
                        599.00,
                        10,
                    ...
                    [
                        'Table basse en bois',
                        'Table basse en chêne massif avec plateau en verre trempé.',
                        189.00,
                        15,
                        'https://images.unsplash.com/photo-1532372320978-9b0a9f4f4f87?w=1200'
                    ],
                    [
                        'Meuble TV 150cm',
                        'Meuble TV avec 2 portes coulissantes et rangement intégré.',
                        249.00,
                        8,
                        'https://images.unsplash.com/photo-1582582621959-48d27397dc69?w=1200'
                    ],
                    [
                        "Canapé d'angle",
                        "Grand canapé d'angle en cuir noir, très confortable et moderne.",
                        899.00,
                        5,
                        'https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=1200'
                    ],
                    [
                        'Étagère murale salon',
                        'Étagère murale en bois flotté, 3 niveaux, style scandinave.',
                        79.00,
                        20,
            ...
            'Chambre' => [
                ...
                'meubles' => [
                    [
                        'Lit 160x200',
                        'Lit double avec tête de lit rembourrée en velours bleu nuit.',
                        449.00,
                        7,
                        'https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=1200'
                    ],
                    [
                        'Armoire 3 portes',
                        'Grande armoire avec miroir central et rangements multiples.',
                        599.00,
                        6,
                    ...
                    [
                        'Table de chevet',
                        'Table de chevet avec tiroir et niche ouverte, en bois naturel.',
                        89.00,
                        25,
                    ...
                    [
                        'Lit 90x200',
                        'Lit simple en bois de pin massif, idéal pour chambre enfant.',
                        229.00,
                        12,
                    ...
                    [
                        'Commode 5 tiroirs',
                        'Commode blanche avec 5 tiroirs spacieux et poignées dorées.',
                        279.00,
                        9,
            ...
            'Bureau' => [
                ...
                'meubles' => [
                    [
                        'Bureau en L',
                        'Bureau en L avec retour et rangement latéral, finition chêne.',
                        349.00,
                        8,
                    ...
                    [
                        'Chaise ergonomique',
                        'Chaise de bureau réglable avec soutien lombaire et accoudoirs.',
                        199.00,
                        15,
                        'https://images.unsplash.com/photo-1580480055273-228ff5388ef8?w=1200'
                    ],
                    [
                        'Bibliothèque 5 niveaux',
                        'Grande bibliothèque en bois avec 5 étagères ajustables.',
                        159.00,
                        10,
                    ...
                    [
                        'Bureau compact',
                        'Bureau compact idéal pour petits espaces, tiroir intégré.',
                        149.00,
                        18,
                    ...
                    [
                        ...
                        'Fauteuil de direction en cuir véritable avec accoudoirs réglables.',
                        329.00,
                        6,
                        'https://images.unsplash.com/photo-1579656592043-a20e25a4aa4b?w=1200'
                    ],
                ],
            ],
            ...
            'Cuisine' => [
                ...
                'meubles' => [
                    [
                        'Table de repas 6 personnes',
                        'Table extensible en chêne pour 6 à 8 personnes.',
                        499.00,
                        7,
                        'https://images.unsplash.com/photo-1617806118233-18e1de247200?w=1200'
                    ],
                    [
                        'Chaise de cuisine lot 4',
                        'Chaise en bois avec assise rembourrée, vendue par lot de 4.',
                        239.00,
                        20,
                    ...
                    [
                        'Îlot de cuisine',
                        'Îlot central avec plan de travail en marbre et rangements.',
                        799.00,
                        4,
                        'https://images.unsplash.com/photo-1484154218962-a197022b5858?w=1200'
                    ],
                    [
                        'Tabouret de bar lot 2',
                        'Tabouret de bar réglable en hauteur, vendu par lot de 2.',
                        149.00,
                        14,
                    ...
                    [
                        'Buffet de cuisine',
                        'Buffet 2 portes avec tiroirs et plan de travail en bois.',
                        359.00,
                        9,
